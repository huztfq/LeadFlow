      ...
      <div className="lf-auth-card-wrap">
        <form onSubmit={handleSubmit} className="lf-auth-card lf-rise">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <label className="lf-auth-label">
              Password
              <span className="lf-auth-password-wrap">
                <input
                  type={showPassword ? "text" : "password"}
                  value={password}
                  onChange={(event) => setPassword(event.target.value)}
                  placeholder="Your password"
                  className="lf-auth-input lf-auth-input-password"
                  required
                />
                <button
                  type="button"
                  className="lf-auth-password-toggle"
          ...
          <div className="lf-auth-footer">
            ...
            <WaitlistButton className="lf-btn lf-btn-primary w-full" />
          </div>
